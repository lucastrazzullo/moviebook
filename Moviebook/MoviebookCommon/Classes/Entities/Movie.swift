...
public struct Movie: Identifiable, Equatable, Hashable {
    ...
    public init(id: Int, details: MovieDetails, genres: [MovieGenre], keywords: [MovieKeyword], cast: [ArtistDetails], production: MovieProduction, watch: WatchProviders, collection: MovieCollection? = nil) {
        self.id = id
